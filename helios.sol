...
/**
    Helios
    Revolutionizing Cross-Chain and ETFs.
    
    Website: https://helios-chain.org
    Twitter: https://twitter.com/helios_chain
    Telegram: https://t.me/HeliosChain
**/
...
contract Helios is ERC20, Ownable {
    ...
    constructor() ERC20("Helios", "HEL") {
        ...
        maxTransactionAmount = 20_000 * 1e18; // 1%
        ...
        marketingWallet = address(0x328982b51A536f736b800ae274Fc3F3f18645b0f);
        developmentWallet = owner(); // set as development wallet
    ...
    function swapBack() private {
        ...
        uint256 ethForDevelopment = ethBalance.mul(tokensForDevelopment).div(totalTokensToSwap - (tokensForLiquidity / 2));
    ...
    function withdrawStuckHelios() external onlyOwner {
